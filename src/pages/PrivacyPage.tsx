...
const sections = [
  ...
  },
  {
    title: 'iCloud Backup',
    paragraphs: [
      'If you choose to enable iCloud backup in the app settings, your habit data is saved to your personal iCloud account. This data is controlled entirely by you through your Apple ID. Chetan Rajesh has no access to your iCloud backup data.',
    ],
  },
  {
  ...
  },
  {
    ...
    link: { text: 'PostHog Privacy Policy', href: 'https://posthog.com/privacy' },
  },
  {
    ...
    link: { text: 'RevenueCat Privacy Policy', href: 'https://www.revenuecat.com/privacy' },
  },
  {
